...
public abstract class Entity implements ICommandListener {
	...
	public double distanceSqrdAccurate(Entity entity) {
		...
		// WindSpigot - knockback.yml 的 lag-compensation.enabled 与 windspigot.yml 开关任一开启即生效
		if ((WindSpigotConfig.improvedHitDetection
				|| com.windpvp.windspigot.knockback.KnockbackEngineSettings.b("lag-compensation.enabled"))
				&& entity instanceof EntityPlayer && this instanceof EntityPlayer) {
